...
#define DD_TASK_SCHEDULER_PRIORITY    0
...
static void DD_Task_Generator_2( void *pvParameters )
{
	...
	while(1)
	{
		...
		/* Creating the DD_Task */
		created_dd_task = create_dd_task(NULL, PERIODIC, TASK2_ID, (current_time + TASK2_PERIOD)); //TODO: Create this function
...
static void user_defined_task_1( void *pvParameters )
{
	...
	vTaskDelete(current_task_handle); //TODO: Should this be moved to a delete_dd_task call?
